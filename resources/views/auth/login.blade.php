...
<head>
    ...
    <title>Login &mdash; Badan Pengembangan Sumber Daya Manusia</title>
    ...
    <link rel="shortcut icon" href="../assets/img/logoSumbar.png" type="image/x-icon">
</head>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="../assets/img/logoSumbar.png" alt="logo" width="80" class="shadow-light mb-5 mt-2">
                        <h5 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Arsip Keuangan</span></h5>
